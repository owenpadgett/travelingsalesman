...
# This code generates cities and tries to find a case where the fastest path is not the same as the shortest
...
# Start checking configurations until paths differ
while True:
    # Generate cities
    ...
    # Check if the shortest and fastest paths differ
    if best_path != fastest_path:
        print("Found differing paths!")
        print("Cities:", cities)
